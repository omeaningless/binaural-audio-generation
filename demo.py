...
from models.networksf21 import VisualNet, VisualNetDilated, AssoConv, APNet1, weights_init, AudioNet1,Attention
...
def main():
    ...
    for audio_file in tqdm(audio_list):
        ...
        #video_path = audio_file.replace('binaural_audios', 'frames')[:-4]
        video_path = audio_file.replace('audio', 'frames')[:-4]
